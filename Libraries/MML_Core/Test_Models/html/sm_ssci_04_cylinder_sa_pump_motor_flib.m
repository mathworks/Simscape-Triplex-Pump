...
% 
% This example models a single piston pump driven by an electric motor.
% The rotation of the pump crankshaft slides the piston back and forth.
% During half of the rotation, fluid is drawn through the inlet check valve
% and out of the tank.  During the other half of the rotation, fluid is
% pushed through the outlet check valve and exits the pump.
%
...
open_system('sm_ssci_04_cylinder_sa_pump_motor_flib')

set_param(find_system('sm_ssci_04_cylinder_sa_pump_motor_flib','MatchFilter',@Simulink.match.allVariants,'FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
