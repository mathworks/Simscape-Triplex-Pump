...
open_system('sm_ssci_03_cylinder_sa_pump_flib')

set_param(find_system('sm_ssci_03_cylinder_sa_pump_flib','MatchFilter',@Simulink.match.allVariants,'FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
